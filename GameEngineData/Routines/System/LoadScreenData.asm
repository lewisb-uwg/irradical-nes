...
;;=========LOAD GRAPHICS BANK
	LDA (temp16),y ;; this is the background graphics bank
...
;==============================Load screen palette	3
	...
	LDA (temp16),y ;; this is the palette data
	STA newPal
...
;;;;;================= this loads the main tiles	4
	...
	LDA (temp16),y ;; this is background tiles
	LSR
	LSR
	LSR
	LSR
	...
	LDA (temp16),y ;; this is screen specific tiles
	AND #%00001111
...
GetScreenTriggerInfo:
		...
		;; other triggered things
			;; first and foremost, get rid of all 'locked doors'
...
;;; this is inline, so no need for RTS.
